              ...
              <tr v-for="user in users" :key="user.id">
                ...
                <td class="px-4 py-2">
                  <button
                    ...
                    class="px-2 py-1 rounded mr-2 action-btn"
                  >
                    Approve
                  </button>
                  <button
        ...
        <div v-if="showDeleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
            ...
            <div class="flex justify-end space-x-4">
              <button @click="cancelDelete" class="px-4 py-2 rounded-md action-btn">Cancel</button>
              <button @click="confirmDelete" class="px-4 py-2 rounded-md bg-red-600 text-white hover:bg-red-700">Delete</button>
            </div>
          </div>
        </div>
